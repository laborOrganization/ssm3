...
public class Bip {
	...
	public String toString() {
		return "Bip [bipId=" + bipId + ", bipCitizenid=" + bipCitizenid + ", bipSex=" + bipSex + ", bipAge=" + bipAge
				+ ", bipName=" + bipName + ", bipBirthday=" + bipBirthday + ", bipMinzu=" + bipMinzu + ", bipZzmm="
				+ bipZzmm + ", bipHyzk=" + bipHyzk + ", bipHjxz=" + bipHjxz + ", bipRylb=" + bipRylb + ", bipJkzk="
				+ bipJkzk + ", bipCjqk=" + bipCjqk + ", bipEyesightleft=" + bipEyesightleft + ", bipEyesightright="
				+ bipEyesightright + ", bipLong=" + bipLong + ", bipWeight=" + bipWeight + ", bipHkszd=" + bipHkszd
				+ ", bipWhcd=" + bipWhcd + ", bipSubject=" + bipSubject + ", bipGraduateschool=" + bipGraduateschool
				+ ", bipBysj=" + bipBysj + ", bipEducationallevel2=" + bipEducationallevel2 + ", bipConTelephone="
				+ bipConTelephone + ", bipConMobile=" + bipConMobile + ", bipConEmail=" + bipConEmail
				+ ", bipConPostcode=" + bipConPostcode + ", bipConContact=" + bipConContact + ", bipConContacttel="
				+ bipConContacttel + ", bipResAddress=" + bipResAddress + ", bipTLowersecurity=" + bipTLowersecurity
				+ ", bipTCriminal=" + bipTCriminal + ", bipTDestitute=" + bipTDestitute + ", bipTPeasant=" + bipTPeasant
				+ ", bipTVeteran=" + bipTVeteran + ", bipTOthercities=" + bipTOthercities + ", bipTCzjyyhz="
				+ bipTCzjyyhz + ", bipTRhfl=" + bipTRhfl + ", bipTNewgraduate=" + bipTNewgraduate + ", bipPcDj="
				+ bipPcDj + ", bipPcSlcd=" + bipPcSlcd + ", bipResume=" + bipResume + ", bipQtsm=" + bipQtsm + "]";
	}
}