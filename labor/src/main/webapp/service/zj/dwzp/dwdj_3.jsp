...
<script type="text/javascript">
	$(function(){
		...
		$("#dwszs").load("../../../Dwdj/getRegioncodeZcs")
		$("#dwszs").change(function(){
			$("#dwszq").load("../../../Dwdj/getRegioncodeZcq",{code:"dwszs",selectedId:$("#dwszs").val(),region:"city"})
			$("#dwszq").change()
		})
		$("#dwszq").change(function(){
			$("#dwszj").load("../../../Dwdj/getRegioncodeZcq",{code:"dwszq",selectedId:$("#dwszq").val(),region:"village"})
		})
